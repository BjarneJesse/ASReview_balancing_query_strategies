...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.05.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.05.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.10.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.10.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.15.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.15.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.20.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.20.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.25.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.25.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.30.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.30.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.35.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.35.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.40.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.40.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.45.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.45.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.50.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.50.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.55.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.55.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.60.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.60.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.65.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.65.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.70.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.70.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.75.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.75.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.80.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.80.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.85.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.85.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.90.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.90.ini
...
python -m asreview simulate data\brouwerschoot.csv -s output\simulation\brouwerschoot\state_files\sim_brouwerschoot_0_ratio_0.95.asreview --init_seed 535 --seed 165 -m nb -e tfidf -q max_uncertainty -b double --n_instances 1 --stop_if min --config_file output\simulation\brouwerschoot\brouwerschoot_config_0.95.ini
